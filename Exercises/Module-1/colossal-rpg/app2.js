...
const porcupine = new WildEnemyOptions(
  "Porcupine",
  "moves slow",
  "16",
  "roasting sticks"
);
const copperhead = new WildEnemyOptions(
  "Copperhead Snake",
  "moves fast",
  "19",
  "fangs"
...
function printHikerDetails() {
  console.log(
    `${hiker.name}, you have ${hiker.hp} health points, and have ${hiker.loot} in your inventory`
  );
}
  ...
  while (stillFighting) {
    ...
    if (userInput == 1) {
      ...
      if (enemy.hp > 0) {
        ...
        console.log(
          `You have taken a hit of ${hikerTakesDamage} health points`
        );
        ...
        stillFighting = false;
        console.log(
          "You have killed off your enemy! Whew, that was a close one. You can continue on your journey.\n"
        );
      }
    } else if (userInput == 2) {
